...
export type IndustrySolutionsData = typeof industrySolutionsData;
...
const IndustrySolutions = ({
  ...
  const { number, eyebrow, title, description, cards, footer } = data;

  return (
    <section
      className={cx("industry-solutions", className)}
      id={id}
    ...
    >
      <Container>
        <div className="industry-solutions__inner">
          <SectionHeading
            prefix="industry-solutions"
            titleId="industry-solutions-title"
            number={number}
            eyebrow={eyebrow}
            title={title}
          ...
          <div className="industry-solutions__footer">
            <div className="industry-solutions__footer-lead">
              <span className="industry-solutions__footer-shield" aria-hidden="true">
                <ShieldIcon />
              </span>
            ...
            <ul className="industry-solutions__footer-list">
              {footer.items.map((item) => (
                <li key={item} className="industry-solutions__footer-item">
                  <span className="industry-solutions__footer-check" aria-hidden="true">
                    <CheckIcon />
                  </span>
                  {item}
                </li>
