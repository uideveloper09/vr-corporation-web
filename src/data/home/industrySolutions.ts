export const industrySolutionsData = {
  ...
  title: "Cooling That Keeps Business Moving.",
  description:
    "Every business has unique cooling needs. V R Corporation delivers tailored Daikin solutions that ensure comfort, productivity and efficiency across every kind of workspace and commercial environment.",
  cards: [
    {
      id: "corporate",
      ...
      iconImage: "/images/brand/01/corporate-offices-icon.png",
    },
    {
      id: "retail",
      ...
      iconImage: "/images/brand/01/retail-showrooms-icon.png",
    },
    {
      id: "factories",
      ...
      iconImage: "/images/brand/01/factories-plants-icon.png",
    },
    {
      id: "hotels",
      ...
      iconImage: "/images/brand/01/hotels-institutions-icon.png",
    },
  ],
  footer: {
    text: "From site study to system planning, installation and dependable care.",
    items: ["Smart Planning", "Expert Installation", "Reliable Aftercare"],
  },
};
