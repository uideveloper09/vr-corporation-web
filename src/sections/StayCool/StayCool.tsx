...
type ItemIcon = (typeof stayCoolData.items)[number]["icon"];
...
const StayCool = () => {
  const { number, eyebrow, title, description, items } = stayCoolData;
    ...
    >
      ...
      <Container>
        <div className="stay-cool__inner">
          <header className="stay-cool__header">
            <span className="stay-cool__number" aria-hidden="true">
              {number}
            </span>

            <div className="stay-cool__intro">
              <p className="stay-cool__eyebrow">{eyebrow}</p>

              <h2 id="stay-cool-title" className="stay-cool__title">
                {title}
              </h2>

              <p className="stay-cool__description">{description}</p>
            </div>
          </header>
