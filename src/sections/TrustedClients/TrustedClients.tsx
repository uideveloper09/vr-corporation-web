...
const TrustedClients = () => {
  const { number, eyebrow, title, description, clients } = trustedClientsData;
    ...
    >
      <Container>
        <div className="trusted-clients__inner">
          <header className="trusted-clients__header">
            <span className="trusted-clients__number" aria-hidden="true">
              {number}
            </span>

            <div className="trusted-clients__intro">
              <p className="trusted-clients__eyebrow">{eyebrow}</p>

              <h2 id="trusted-clients-title" className="trusted-clients__title">
                {title}
              </h2>

              <p className="trusted-clients__description">{description}</p>
            </div>
          </header>
