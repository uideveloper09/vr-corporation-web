...
const ProductSolutions = () => {
  const { number, eyebrow, title, description, cards } = productSolutionsData;

  return (
    <section
      className="product-solutions"
      id="product-solutions"
      aria-labelledby="product-solutions-title"
    >
      <Container>
        <div className="product-solutions__inner">
          <header className="product-solutions__header">
            <span className="product-solutions__number" aria-hidden="true">
              {number}
            </span>

            <div className="product-solutions__intro">
              <p className="product-solutions__eyebrow">{eyebrow}</p>

              <h2
                id="product-solutions-title"
                className="product-solutions__title"
              >
                {title}
              </h2>

              <p className="product-solutions__description">{description}</p>
            </div>
          </header>
              ...
              return (
                <article key={card.id} className="product-solutions__card">
                  <div className="product-solutions__card-media">
                    ...
                    <span
                      className="product-solutions__card-icon"
                      aria-hidden="true"
                    >
                      <Icon />
                    </span>
                  ...
                  <div className="product-solutions__card-body">
                    <h3 className="product-solutions__card-title">
                      {card.title}
                    </h3>
                    <span
                      className="product-solutions__card-rule"
                      aria-hidden="true"
                    />
                    ...
                    <a
                      className="product-solutions__card-link"
                      href={card.href}
                    >
